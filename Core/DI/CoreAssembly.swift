...
final public class CoreAssembly {
    ...
    public private(set) lazy var listAssembly = ListAssembly(webServiceAssembly: webServiceAssembly, geolocationAssembly: geolocationAssembly, containerAssembly: containerAssembly)
